...
package com.droplit.wave.widgets;
...
import com.droplit.wave.widgets.ColorPickerView.OnColorChangedListener;
...
public class ColorSchemeDialog extends AlertDialog implements
    ...
    /*
     * (non-Javadoc)
     * @see com.droplit.wave.widgets.ColorPickerView.OnColorChangedListener#
     * onColorChanged(int)
     */
    @Override
