...
import com.droplit.wave.widgets.ColorPickerView;
import com.droplit.wave.widgets.ColorSchemeDialog;
...
public final class WVUtils {
    ...
    public static void createShortcutIntent(final String displayName, final String artistName,
        ...
        try {
            ...
            Log.e("WVUtils", "createShortcutIntent", e);
            AppMsg.makeText(
                    context,
